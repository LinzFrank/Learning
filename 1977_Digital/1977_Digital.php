...
/*
Plugin Name: 1977_Digital #3401697
...
add_action( 'admin_init', array('MyFontsInstaller_3401697','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3401697','mffonts_loadupWebfonts' ));